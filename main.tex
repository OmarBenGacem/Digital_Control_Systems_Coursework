...
\begin{figure}[H]
    ...
    \caption{B4) Discrete-Time System Responses with an Unstable Sampling Time}
    \label{B4}
\end{figure}
...
The non-linear system was simulated using the same discrete time controller, sampled across a variety of sampling times. The experiment was run across 6 trials, all shown in Figure \ref{B5}

\begin{figure}[H]
    \centering
    % \includegraphics[width=20cm]{figures/B5.png}
    \includegraphics[width=\textwidth]{figures/B5.png}
    \caption{B5) Nonlinear System Responses to a Digital Controller with Different Sampling Frequencies}
    \label{B5}
\end{figure}

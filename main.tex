...
\begin{equation}\label{acctf}
    sX(s)-AX(s)=BU(s)\rightarrow \frac{X(s)}{U(s)}=\frac{B}{Is-A}= 
\end{equation}

\paragraph{Equivalent Discrete Time Model}

The equivalent discrete-time model for this system cana be derr
